...
:: Backend
start "BACKEND" cmd /k "cd /d "%~dp0backend" && venv\Scripts\activate && echo Backend ishga tushdi! && python manage.py runserver"

:: 3 soniya kutish
timeout /t 3 /nobreak >nul

:: Frontend
start "FRONTEND" cmd /k "cd /d "%~dp0frontend" && echo Frontend ishga tushdi! && npm run dev"

:: 5 soniya kutish va brauzer ochish
